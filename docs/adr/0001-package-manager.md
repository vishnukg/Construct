...
Construct is a TypeScript CLI/TUI project that currently uses Node, npm, Ink, Vitest, ESLint, and tsup. The project also follows a container-first workflow, so the package manager runs inside Docker through Make targets.
